...
final class LiveSearchViewModel {
  ...
  func downloadSearchResults() {
    ...
    searchDebounceTimer = Timer.scheduledTimer(withTimeInterval: 0.5, repeats: false) { [weak self] _ in
      ...
      Task {
        do {
          let productsResponse = try await APIService.request(ProductsResponse.self, from: SearchAPI.search(search: strongSelf.searchText, skip: 0, limit: strongSelf.liveSearchLimit))
